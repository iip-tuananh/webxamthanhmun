        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" class="form-control" ng-model="form.subtitle">
                    <div class="invalid-feedback d-block"><% errors.subtitle[0] %></div>
                </div>


                <div class="form-group mb-4">
                    <label class="form-label">Text Button</label>
                    <input type="text" class="form-control" ng-model="form.text_button">
                    <div class="invalid-feedback d-block"><% errors.text_button[0] %></div>
                </div>

                <div class="form-group mb-4">
                    <label class="form-label">Link liên kết</label>
                    <input type="text" class="form-control" ng-model="form.link">
                    <div class="invalid-feedback d-block"><% errors.link[0] %></div>
                </div>
