...
<div class="row">
    <div class="col-sm-8">
        <div class="form-group custom-group mb-4">
            <label class="form-label required-label">Tên thành viên</label>
            ...
            <div class="form-group custom-group">
                <div class="row gx-3 gy-2">
                    ...
                    <div class="col-6 col-md-3">
                        ...
                        <input class="form-control" type="text" ng-model="form.pri" placeholder="Youtube URL">
                    </div>
                    <div class="col-6 col-md-3">
        ...
        <div class="form-group custom-group mb-4">
            <label class="form-label">Giới thiệu 1</label>
            <textarea id="my-textarea" class="form-control" rows="5" ng-model="form.description_1"></textarea>
            <span class="invalid-feedback d-block" role="alert">
                <strong>
                    <% errors.description_1[0] %>
                </strong>
            </span>
        </div>

        <div class="form-group custom-group mb-4">
            <label class="form-label">Giới thiệu 2</label>
            <textarea id="my-textarea" class="form-control" rows="5" ng-model="form.description_2"></textarea>
            <span class="invalid-feedback d-block" role="alert">
                <strong>
                    <% errors.description_2[0] %>
                </strong>
            </span>
        </div>
...
<div class="text-right">
    ...
    <a href="{{ route('teams.index') }}" class="btn btn-danger btn-cons">
