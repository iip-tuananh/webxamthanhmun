...
@section('title'){{ $course->name }} - {{ $config->web_title }}@endsection
...
@section('content')
    <main class="wrapper" ng-controller="servicePage">
        ...
        <div class="wptb-page-heading">
            <div class="wptb-item--inner" style="background-image: url('{{ @$course->image_back->path ?? '' }}');">
                <div class="wptb-item-layer wptb-item-layer-one">
                    <img src="/site/img/more/circle.png" alt="img">
                </div>
                <h2 class="wptb-item--title "> {{ $course->name }}</h2>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 pe-md-5">
                        <div class="sidebar">
                            <div class="sidenav">
                                <ul class="side_menu">
                                    @foreach($otherCourses as $otherService)
                                        <li class="menu-item {{ $otherService->id == $course->id ? 'active' : '' }}">
                                            <a href="{{ route('front.getCourseDetail', $otherService->slug) }}" class="d-flex align-items-center justify-content-between">
                                                <span>
                                                    {{ $otherService->name }}
                                                </span>
                        ...
                        <div class="blog-details-inner">
                            <div class="post-content">
                                ...
                                <figure class="block-gallery mb-4">
                                    <img src="{{ $course->image->path ?? '' }}" alt="img">
                                </figure>
