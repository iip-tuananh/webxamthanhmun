...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'about-page'], function () {
        Route::get('/', 'Admin\AboutPageController@index')->name('aboutPage.index');
        Route::get('/show', 'Admin\AboutPageController@show')->name('aboutPage.show');
        Route::get('/getData', 'Admin\AboutPageController@getData')->name('aboutPage.getData');
    ...
    Route::group(['prefix' => 'register-banner'], function () {
        Route::get('/', 'Admin\RegisterBannerController@edit')->name('registerBanner.edit');
        Route::post('/update', 'Admin\RegisterBannerController@update')->name('registerBanner.update');
    });

    Route::group(['prefix' => 'order-banner'], function () {
        Route::get('/', 'Admin\OrderBannerController@edit')->name('orderPages.edit');
    ...
    Route::group(['prefix' => 'team-banner'], function () {
        ...
        Route::post('/update', 'Admin\TeamBannerController@update')->name('teamBanner.update');
    });
    ...
    Route::group(['prefix' => 'teams'], function () {
        ...
        Route::get('/{id}/edit', 'Admin\TeamController@edit')->name('teams.edit');
    ...
    Route::group(['prefix' => 'courses'], function () {
        ...
        Route::get('/searchData', 'Admin\CoursesController@searchData')->name('courses.searchData');
        Route::post('/', 'Admin\CoursesController@store')->name('courses.store');
        Route::get('/{id}/edit', 'Admin\CoursesController@edit')->name('courses.edit');
        Route::post('/{id}/update', 'Admin\CoursesController@update')->name('courses.update');
        Route::get('/{id}/delete', 'Admin\CoursesController@delete')->name('courses.delete');
    });
